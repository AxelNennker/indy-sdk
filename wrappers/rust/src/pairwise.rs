...
pub fn is_pairwise_exists(wallet_handle: WalletHandle, their_did: &str) -> Box<dyn Future<Output=Result<bool, IndyError>>> {
...
pub fn create_pairwise(wallet_handle: WalletHandle, their_did: &str, my_did: &str, metadata: Option<&str>) -> Box<dyn Future<Output=Result<(), IndyError>>> {
...
pub fn list_pairwise(wallet_handle: WalletHandle) -> Box<dyn Future<Output=Result<String, IndyError>>> {
...
pub fn get_pairwise(wallet_handle: WalletHandle, their_did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn set_pairwise_metadata(wallet_handle: WalletHandle, their_did: &str, metadata: Option<&str>) -> Box<dyn Future<Output=Result<(), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec();
