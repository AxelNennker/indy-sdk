...
pub fn create_and_store_my_did(wallet_handle: WalletHandle, did_json: &str) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
...
/// # Returns
/// * `verkey` - The DIDs verification key
pub fn replace_keys_start(wallet_handle: WalletHandle, tgt_did: &str, identity_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
...
pub fn replace_keys_apply(wallet_handle: WalletHandle, tgt_did: &str) -> Box<dyn Future<Output=Result<(), IndyError>>> {
...
///     }
pub fn store_their_did(wallet_handle: WalletHandle, identity_json: &str) -> Box<dyn Future<Output=Result<(), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec();
...
pub fn key_for_did(pool_handle: PoolHandle, wallet_handle: WalletHandle, did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// * `key` - The DIDs ver key (key id).
pub fn key_for_local_did(wallet_handle: WalletHandle, did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn set_endpoint_for_did(wallet_handle: WalletHandle, did: &str, address: &str, transport_key: &str) -> Box<dyn Future<Output=Result<(), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec();
...
pub fn get_endpoint_for_did(wallet_handle: WalletHandle, pool_handle: PoolHandle, did: &str) -> Box<dyn Future<Output=Result<(String, Option<String>), IndyError>>> {
...
pub fn set_did_metadata(wallet_handle: WalletHandle, tgt_did: &str, metadata: &str) -> Box<dyn Future<Output=Result<(), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec();
...
pub fn get_did_metadata(wallet_handle: WalletHandle, tgt_did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
///   }
pub fn get_my_did_with_metadata(wallet_handle: WalletHandle, my_did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
///     "metadata": string - The meta information stored with the DID
///   }]
pub fn list_my_dids_with_metadata(wallet_handle: WalletHandle) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn abbreviate_verkey(tgt_did: &str, verkey: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// fully qualified did
pub fn qualify_did(wallet_handle: WalletHandle, did: &str, method: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
