...
pub fn sign_and_submit_request(pool_handle: PoolHandle, wallet_handle: WalletHandle, submitter_did: &str, request_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
...
/// # Returns
/// Request result as json.
pub fn submit_request(pool_handle: PoolHandle, request_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn submit_action(pool_handle: PoolHandle, request_json: &str, nodes: Option<&str>, wait_timeout: Option<i32>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Signed request json.
pub fn sign_request(wallet_handle: WalletHandle, submitter_did: &str, request_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Signed request json.
pub fn multi_sign_request(wallet_handle: WalletHandle, submitter_did: &str, request_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_ddo_request(submitter_did: Option<&str>, target_did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_nym_request(submitter_did: &str, target_did: &str, verkey: Option<&str>, data: Option<&str>, role: Option<&str>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_nym_request(submitter_did: Option<&str>, target_did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
///                             201 - NETWORK_MONITOR
/// }
pub fn parse_get_nym_response(get_nym_response: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_txn_request(submitter_did: Option<&str>, ledger_type: Option<&str>, seq_no: i32) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_attrib_request(submitter_did: &str, target_did: &str, hash: Option<&str>, raw: Option<&str>, enc: Option<&str>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_attrib_request(submitter_did: Option<&str>, target_did: &str, raw: Option<&str>, hash: Option<&str>, enc: Option<&str>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_schema_request(submitter_did: &str, data: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_schema_request(submitter_did: Option<&str>, id: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
///     ver: Version of the Schema json
/// }
pub fn parse_get_schema_response(get_schema_response: &str) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
...
/// # Returns
/// Request result as json.
pub fn build_cred_def_request(submitter_did: &str, data: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_cred_def_request(submitter_did: Option<&str>, id: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// }
pub fn parse_get_cred_def_response(get_cred_def_response: &str) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string_string();
...
/// # Returns
/// Request result as json.
pub fn build_node_request(submitter_did: &str, target_did: &str, data: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_validator_info_request(submitter_did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_pool_config_request(submitter_did: &str, writes: bool, force: bool) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_pool_restart_request(submitter_did: &str, action: &str, datetime: Option<&str>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn build_pool_upgrade_request(submitter_did: &str,
                                  ...
                                  reinstall: bool,
                                  force: bool,
                                  package: Option<&str>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_revoc_reg_def_request(submitter_did: &str, data: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_revoc_reg_def_request(submitter_did: Option<&str>, id: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
///     "ver": string - version of revocation registry definition json.
/// }
pub fn parse_get_revoc_reg_def_response(get_revoc_reg_def_response: &str) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string_string();
...
/// # Returns
/// Request result as json.
pub fn build_revoc_reg_entry_request(submitter_did: &str, revoc_reg_def_id: &str, rev_def_type: &str, value: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_revoc_reg_request(submitter_did: Option<&str>, revoc_reg_def_id: &str, timestamp: i64) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// }
pub fn parse_get_revoc_reg_response(get_revoc_reg_response: &str) -> Box<dyn Future<Output=Result<(String, String, u64), IndyError>>> {
...
/// # Returns
/// Request result as json.
pub fn build_get_revoc_reg_delta_request(submitter_did: Option<&str>, revoc_reg_def_id: &str, from: i64, to: i64) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// }
pub fn parse_get_revoc_reg_delta_response(get_revoc_reg_delta_response: &str) -> Box<dyn Future<Output=Result<(String, String, u64), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string_string_u64();
...
/// }
pub fn get_response_metadata(response: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn build_auth_rule_request(submitter_did: &str, txn_type: &str, action: &str, field: &str,
                               old_value: Option<&str>, new_value: Option<&str>, constraint: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_auth_rules_request(submitter_did: &str, data: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn build_get_auth_rule_request(submitter_did: Option<&str>, txn_type: Option<&str>, action: Option<&str>, field: Option<&str>,
                                   old_value: Option<&str>, new_value: Option<&str>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_txn_author_agreement_request(submitter_did: &str, text: Option<&str>, version: &str, ratification_ts: Option<u64>, retirement_ts: Option<u64>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_disable_all_txn_author_agreements_request(submitter_did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_txn_author_agreement_request(submitter_did: Option<&str>, data: Option<&str>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_acceptance_mechanisms_request(submitter_did: &str, aml: &str, version: &str, aml_context: Option<&str>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// # Returns
/// Request result as json.
pub fn build_get_acceptance_mechanisms_request(submitter_did: Option<&str>, timestamp: Option<i64>, version: Option<&str>) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn append_txn_author_agreement_acceptance_to_request(request_json: &str,
                                                         ...
                                                         mechanism: &str,
                                                         time: u64) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn append_request_endorser(request_json: &str,
                               endorser_did: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
