...
/// }
pub fn create_pool_ledger_config(pool_name: &str, pool_config: Option<&str>) -> Box<dyn Future<Output=Rsult<(), IndyError>>> {
...
pub fn open_pool_ledger(pool_name: &str, config: Option<&str>) -> Box<dyn Future<Output=Result<CommandHandle, IndyError>>> {
...
pub fn refresh_pool_ledger(pool_handle: PoolHandle) -> Box<dyn Future<Output=Result<(), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec();
...
pub fn list_pools() -> Box<dyn Future<Output=Result<String, IndyError>>> {
...
/// # Arguments
/// * `handle` - pool handle returned by open_ledger.
pub fn close_pool_ledger(pool_handle: PoolHandle) -> Box<dyn Future<Output=Result<(), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec();
...
pub fn delete_pool_ledger(pool_name: &str) -> Box<dyn Future<Output=Result<(), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec();
...
///     1 - for Indy Node 1.3
///     2 - for Indy Node 1.4
pub fn set_protocol_version(protocol_version: usize) -> Box<dyn Future<Output=Result<(), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec();
