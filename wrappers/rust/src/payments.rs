...
pub fn create_payment_address(wallet_handle: WalletHandle, payment_method: &str, config: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
...
pub fn list_payment_addresses(wallet_handle: WalletHandle) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn add_request_fees(wallet_handle: WalletHandle,
                        ...
                        inputs_json: &str,
                        outputs_json: &str,
                        extra: Option<&str>) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
...
///   }]
pub fn parse_response_with_fees(payment_method: &str, resp_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn build_get_payment_sources_request(wallet_handle: WalletHandle, submitter_did: Option<&str>, payment_address: &str) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
...
/// * `get_utxo_txn_json` - Indy request for getting UTXO list for payment address
/// * `payment_method`
pub fn build_get_payment_sources_with_from_request(wallet_handle: WalletHandle, submitter_did: Option<&str>, payment_address: &str, from: Option<i64>) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
    let (receiver, command_handle, cb) =
        ClosureHandler::cb_ec_string_string();
...
///   }]
#[deprecated(since="2.0.0", note="please use `parse_get_payment_sources_with_from_response` instead")]
pub fn parse_get_payment_sources_response(payment_method: &str, resp_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn parse_get_payment_sources_with_from_response(payment_method: &str, resp_json: &str) -> Box<dyn Future<Output=Result<(String, Option<i64>), IndyError>>> {
...
/// * `payment_method`
pub fn build_payment_req(wallet_handle: WalletHandle, submitter_did: Option<&str>, inputs: &str, outputs: &str, extra: Option<&str>) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string_string();
...
///      extra: <str>, // optional data from payment transaction
///   }]
pub fn parse_payment_response(payment_method: &str, resp_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// * `payment_method`
pub fn build_mint_req(wallet_handle: WalletHandle, submitter_did: Option<&str>, outputs_json: &str, extra: Option<&str>) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string_string();
...
pub fn build_set_txn_fees_req(wallet_handle: WalletHandle, submitter_did: Option<&str>, payment_method: &str, fees_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn build_get_txn_fees_req(wallet_handle: WalletHandle, submitter_did: Option<&str>, payment_method: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
///   txnTypeN: amountN,
/// }
pub fn parse_get_txn_fees_response(payment_method: &str, resp_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn build_verify_payment_req(wallet_handle: WalletHandle, submitter_did: Option<&str>, receipt: &str) -> Box<dyn Future<Output=Result<(String, String), IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string_string();
...
pub fn parse_verify_payment_response(payment_method: &str, resp_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
/// }
///
pub fn get_request_info(get_auth_rule_resp_json: &str, requester_info_json: &str, fees_json: &str) -> Box<dyn Future<Output=Result<String, IndyError>>> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
pub fn sign_with_address(wallet_handle: WalletHandle, address: &str, message: &[u8]) -> Box<dyn Future<Output=Result<Vec<u8>, IndyError>>> {
...
pub fn verify_with_address(address: &str, message: &[u8], signature: &[u8]) -> Box<dyn Future<Output=Result<bool, IndyError>>> {
